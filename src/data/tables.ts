  ...
  rows: [
    {
      ...
      maxRoll: 1,
      id: 'loot_d20_1',
      name: 'Salted Beef & Hardtack (Food Ration)',
      subtitle: '1d6+2 Gold + Ration (+8 HP / +6 Energy)',
      description: 'Hearty dried provisions to replenish vital health and combat energy.',
      icon: 'Utensils',
      badge: 'Supplies (5g)',
      data: {
        goldFormula: '1d6+2',
        itemId: 'dungeon_ration',
        itemRarity: 'common',
        description: 'Pouch of silver coins and 1x Salted Beef & Hardtack',
      },
    },
    {
      minRoll: 2,
      maxRoll: 2,
      id: 'loot_d20_2',
      name: 'Sturdy Leather Boots (Footwear)',
      subtitle: '1d6+4 Gold + Leather Boots (+1 AC, +1 DEX)',
      description: 'Thick-soled tread that prevents slipping on dungeon slime while enhancing agility.',
      icon: 'Footprints',
      badge: 'Boots (10g)',
      data: {
        goldFormula: '1d6+4',
        itemId: 'adventurers_boots',
        itemRarity: 'common',
        description: 'Gold coins and Sturdy Leather Boots',
      },
    },
    {
      minRoll: 3,
      maxRoll: 3,
      id: 'loot_d20_3',
      name: 'Reinforced Wooden Buckler (Shield)',
      subtitle: '1d6+6 Gold + Oak Buckler (+1 Armor Class)',
      description: 'A lightweight iron-rimmed oak shield that deflects glancing monster claws.',
      icon: 'Shield',
      badge: 'Shield (10g)',
      data: {
        goldFormula: '1d6+6',
        ...
        itemRarity: 'common',
        description: 'Gold coins and a Reinforced Wooden Buckler',
      },
    },
    {
      minRoll: 4,
      maxRoll: 4,
      id: 'loot_d20_4',
      name: 'Minor Health Potion (Healing)',
      subtitle: '2d6+4 Gold + Health Draught (+12 HP)',
      description: 'A sealed crimson phial of alchemical tonic that immediately knits flesh and seals wounds.',
      icon: 'Heart',
      badge: 'Potion (10g)',
      data: {
        goldFormula: '2d6+4',
        ...
        itemRarity: 'common',
        description: 'Gold coins and a Minor Health Potion',
      },
    },
    {
      minRoll: 5,
      maxRoll: 5,
      id: 'loot_d20_5',
      name: 'Energy Draught (Energy Restoration)',
      subtitle: '2d6+6 Gold + Energy Potion (+15 Energy)',
      description: 'Effervescent sapphire liquid that restores combat vigor and activates hero skills.',
      icon: 'Sparkles',
      badge: 'Potion (12g)',
      data: {
        goldFormula: '2d6+6',
        itemId: 'mana_draught',
        itemRarity: 'common',
        description: 'Gold coins and an Energy Potion',
      },
    },
    {
      minRoll: 6,
      maxRoll: 6,
      id: 'loot_d20_6',
      name: 'Padded Leather Tunic (Light Armor)',
      subtitle: '2d6+8 Gold + Leather Tunic (+1 AC, +1 DEX)',
      description: 'Supple cured leather armor providing agile protection against cuts and darts.',
      icon: 'Shirt',
      badge: 'Armor (12g)',
      data: {
        goldFormula: '2d6+8',
        ...
        itemRarity: 'common',
        description: 'Gold coins and a Padded Leather Tunic',
      },
    },
    {
      minRoll: 7,
      maxRoll: 7,
      id: 'loot_d20_7',
      name: 'Honed Iron Shortsword (Weapon)',
      subtitle: '3d6+8 Gold + Shortsword (1d6+1 Dmg, +1 STR)',
      description: 'A well-balanced double-edged steel blade ideal for close-quarters skirmishing.',
      icon: 'Sword',
      badge: 'Weapon (15g)',
      data: {
        goldFormula: '3d6+8',
        ...
        itemRarity: 'common',
        description: 'Gold coins and an Iron Shortsword',
      },
    },
    {
      minRoll: 8,
      maxRoll: 8,
      id: 'loot_d20_8',
      name: 'Scroll of Fireball (Direct Damage Spell)',
      subtitle: '3d6+10 Gold + Fire Scroll (3d8 Fire Damage)',
      description: 'Ancient parchment inscribed with pyromantic runes that unleash an explosive fireball in battle.',
      icon: 'Flame',
      badge: 'Scroll (20g)',
      data: {
        goldFormula: '3d6+10',
        ...
        itemRarity: 'uncommon',
        description: 'Gold coins and a Scroll of Fireball',
      },
    },
    {
      minRoll: 9,
      maxRoll: 9,
      id: 'loot_d20_9',
      name: 'Greater Health Elixir (Potent Healing)',
      subtitle: '3d6+12 Gold + Greater Potion (+28 HP)',
      description: 'Luminescent ruby elixir crafted from rare mountain herbs that cures fatal injuries.',
      icon: 'Heart',
      badge: 'Potion (25g)',
      data: {
        goldFormula: '3d6+12',
        ...
        itemRarity: 'uncommon',
        description: 'Gold coins and a Greater Health Elixir',
      },
    },
    {
      minRoll: 10,
      maxRoll: 10,
      id: 'loot_d20_10',
      name: 'Silver Order Kite Shield (Shield)',
      subtitle: '4d6+10 Gold + Kite Shield (+2 AC, +1 CON)',
      description: 'Solid triangular steel shield offering heavy frontal missile and melee deflection.',
      icon: 'ShieldAlert',
      badge: 'Shield (25g)',
      data: {
        goldFormula: '4d6+10',
        itemId: 'iron_kite_shield',
        itemRarity: 'uncommon',
        description: 'Gold coins and an Iron Kite Shield',
      },
    },
    {
      minRoll: 11,
      maxRoll: 11,
      id: 'loot_d20_11',
      name: "Burglar's Brass Spyglass (Scouting Tool)",
      subtitle: '4d6+12 Gold + Spyglass (Scouts Adjacent Rooms)',
      description: 'A precision brass optic tool enabling safe inspection of connected rooms without torches.',
      icon: 'Compass',
      badge: 'Tool (28g)',
      data: {
        goldFormula: '4d6+12',
        itemId: 'brass_spyglass',
        itemRarity: 'uncommon',
        description: "Gold coins and a Burglar's Spyglass",
      },
    },
    {
      minRoll: 12,
      maxRoll: 12,
      id: 'loot_d20_12',
      name: 'Dice of Fate (Reroll Relic)',
      subtitle: '4d6+15 Gold + Fate Die (+1 Reroll Token)',
      description: 'Enchanted bone die humming with fortune, granting an extra Fate Reroll token.',
      icon: 'Dices',
      badge: 'Relic (30g)',
      data: {
        goldFormula: '4d6+15',
        itemId: 'dice_of_fate',
        itemRarity: 'rare',
        description: 'Gold coins and the Dice of Fate',
      },
    },
    {
      minRoll: 13,
      maxRoll: 13,
      id: 'loot_d20_13',
      name: 'Ring of Vitality (Constitution Boost)',
      subtitle: '5d6+15 Gold + Bloodstone Ring (+2 CON)',
      description: 'A warm bloodstone band that steadily strengthens your heart and increases maximum HP.',
      icon: 'Heart',
      badge: 'Ring (35g)',
      data: {
        goldFormula: '5d6+15',
        ...
        itemRarity: 'uncommon',
        description: 'Gold coins and a Ring of Vitality',
      },
    },
    {
      minRoll: 14,
      maxRoll: 14,
      id: 'loot_d20_14',
      name: 'Silver Warding Amulet (Protection & Luck)',
      subtitle: '5d6+18 Gold + Talisman (+1 AC, +1 LCK)',
      description: 'An engraved silver medallion that radiates warding aura, improving both armor and luck.',
      icon: 'Shield',
      badge: 'Amulet (35g)',
      data: {
        goldFormula: '5d6+18',
        ...
        itemRarity: 'uncommon',
        description: 'Gold coins and a Silver Warding Amulet',
      },
    },
    {
      minRoll: 15,
      maxRoll: 15,
      id: 'loot_d20_15',
      name: "Gambler's Lucky Ring (Luck & Criticals)",
      subtitle: '5d6+22 Gold + Silver Band (+3 LCK)',
      description: 'Carved with dice pips, massively increasing critical strike frequency and treasure luck.',
      icon: 'Dices',
      badge: 'Ring (40g)',
      data: {
        goldFormula: '5d6+22',
        ...
        itemRarity: 'uncommon',
        description: "Gold coins and a Gambler's Lucky Ring",
      },
    },
    {
      minRoll: 16,
      maxRoll: 16,
      id: 'loot_d20_16',
      name: 'Crusader Wall Axe (Breaching Weapon)',
      subtitle: '6d6+20 Gold + Wall Axe (1d8+2 Dmg, Wall Breach)',
      description: 'Heavy battleaxe that carves through foes and demolishes interior dungeon stone walls.',
      icon: 'Hammer',
      badge: 'Weapon (42g)',
      data: {
        goldFormula: '6d6+20',
        itemId: 'wall_axe',
        itemRarity: 'uncommon',
        description: 'Gold coins and a Crusader Wall Axe',
      },
    },
    {
      minRoll: 17,
      maxRoll: 17,
      id: 'loot_d20_17',
      name: 'Tempered Chainmail Hauberk (Heavy Armor)',
      subtitle: '6d6+25 Gold + Chainmail (+3 AC, +1 CON)',
      description: 'Riveted steel rings forged to absorb ferocious monster attacks and crushing impacts.',
      icon: 'ShieldCheck',
      badge: 'Armor (45g)',
      data: {
        goldFormula: '6d6+25',
        itemId: 'chainmail_hauberk',
        itemRarity: 'uncommon',
        description: 'Gold coins and a Chainmail Hauberk',
      },
    },
    {
      minRoll: 18,
      maxRoll: 18,
      id: 'loot_d20_18',
      name: 'Boots of the Windrunner (Agility & Speed)',
      subtitle: '7d6+30 Gold + Elven Boots (+1 AC, +3 DEX, +2 LCK)',
      description: 'Feather-light elven footwear providing unmatched movement, agility, and evasive luck.',
      icon: 'Wind',
      badge: 'Boots (70g)',
      data: {
        goldFormula: '7d6+30',
        itemId: 'boots_of_haste',
        itemRarity: 'rare',
        description: 'Gold coins and Boots of the Windrunner',
      },
    },
    {
      minRoll: 19,
      maxRoll: 19,
      id: 'loot_d20_19',
      name: 'Champion Plate Armor (Masterwork Plate)',
      subtitle: '8d6+40 Gold + Champion Plate (+5 AC, +2 STR, +2 CON)',
      description: 'Flawless steel plate armor inscribed with defensive sigils of ancient champions.',
      icon: 'ShieldCheck',
      badge: 'Epic Armor (95g)',
      data: {
        goldFormula: '8d6+40',
        itemId: 'plate_armor_of_the_champion',
        itemRarity: 'rare',
        description: 'Gold coins and Champion Plate Armor',
      },
    },
    {
      minRoll: 20,
      maxRoll: 20,
      id: 'loot_d20_20',
      name: 'Dragonslayer Greatblade (Epic Wyrm-Bane)',
      subtitle: '10d6+60 Gold + Dragonslayer Blade (2d8+5 Dmg, +4 STR)',
      description: 'A legendary meteorite greatsword forged during the wyrm wars to annihilate behemoths!',
      icon: 'Flame',
      badge: 'Legendary (150g)',
      data: {
        goldFormula: '10d6+60',
        itemId: 'dragonslayer_greatsword',
        itemRarity: 'epic',
        description: 'Massive treasure chest and the legendary Dragonslayer Greatblade!',
      },
    },
  ],
};
