...
export const STARTING_BOON_TABLE: RollableTable<StartingBoon> = {
  ...
  rows: [
    ...
    },
    {
      ...
      maxRoll: 3,
      id: 'masterwork_picks',
      name: "Thieves' Master Lockpick Kit",
      subtitle: 'Reusable Tool & +15 Gold',
      description: 'Tempered steel tension wrenches and notched picks that never break on use.',
      icon: 'Key',
      badge: 'Reusable Tool',
      data: { type: 'lockpicks', value: 1, grantText: "1x Reusable Thieves' Lockpick Kit & +15 Gold" },
    },
    {
      minRoll: 4,
      maxRoll: 4,
